...
namespace zcpm
{
    ...
    // Instruction numbers, opcodes are converted to these numbers using tables generated by maketables.c.
    enum Instruction : uint8_t
    {
        ...
        ED_UNDEFINED /* ED_UNDEFINED is used to catch undefined 0xed prefixed opcodes. */
