...
namespace ZCPM
{
  ...
  public:
    ...
    // Return a brief human-readable summary of this FCB for logging purposes. If show_both_filenames is not set then
    // just show the single filename, but if show_both_filenames is set then also show the filename at +10H etc
